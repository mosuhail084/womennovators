      ...
      <div class="col-lg-12 col-md-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.create_normal_event') }}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="col-4">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="file" class="form-control" id="profile-img" name="normal_event_poster"
                      id="normal_event_poster" required>
                  </div>
                </div>
              ...
              <div class="row row-sm">
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="normal_event_start_date" id="normal_event_start_date" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="normal_event_end_date" id="normal_event_end_date" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="normal_event_from" id="normal_event_from" required> 
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="normal_event_to" id="normal_event_to" required>
                  </div>
                </div>

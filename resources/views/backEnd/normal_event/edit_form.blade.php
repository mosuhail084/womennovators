      ...
      <div class="col-lg-12 col-md-12">
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.update_normal_event', ['id' => $event->id]) }}"
              ...
              <div class="row row-sm">
                ...
                <div class="col-4">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="text" class="form-control" name="normal_event_title" id="normal_event_title"
                      placeholder="Enter Event Name" value="{{ $event->normal_event_title ?? '' }}" required>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-9">
                      <div class="form-group mg-b-0">
                        ...
                        <input type="file" class="form-control" id="profile-img" name="normal_event_poster"
                          id="normal_event_poster">
                      </div>
                    </div>
                    <div class="col-3">
                      @if ($event->normal_event_poster)
                        <img src="{{ asset('we/images/' . $event->normal_event_poster) }}" height="70" width="70"
                          alt="poster">
                      @endif
                    </div>
                  </div>
                ...
                <div class="col-4">
                  <div class="form-group mg-b-0">
                    ...
                    <select class="form-control" name="normal_event_mode" id="normal_event_mode" required>
                      <option value="">Please Select One</option>
                      @if ($event->normal_event_mode == 'online')
              ...
              <div class="row row-sm">
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="normal_event_start_date" id="normal_event_start_date"
                      value="{{ $event->normal_event_start_date ?? '' }}" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="date" class="form-control" name="normal_event_end_date" id="normal_event_end_date"
                      value="{{ $event->normal_event_end_date ?? '' }}" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="normal_event_from" id="normal_event_from"
                      value="{{ $event->normal_event_from ?? '' }}" required>
                  </div>
                </div>
                ...
                <div class="col-3">
                  <div class="form-group mg-b-0">
                    ...
                    <input type="time" class="form-control" name="normal_event_to" id="normal_event_to"
                      value="{{ $event->normal_event_to ?? '' }}" required>
                  </div>
                </div>
              ...
              <div class="row row-sm">
                ...
                <div class="col-12">
                  <div class="form-group mg-b-0">
                    ...
                    <textarea class="form-control summernote" name="normal_event_desc" id="normal_event_desc" rows="3"
                      placeholder="" required>{!! $event->normal_event_desc ?? '' !!}</textarea>
                  </div>
                </div>
              </div>
